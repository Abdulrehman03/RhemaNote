...
const Header = () => {
  ...
  const { setSearchDetail, storeData, setInputVerse, setInputChannel } =
            ...
            <Box sx={{ display: { xs: "none", md: "flex" } }}>
              {pages.map((page) => (
                <Button
                  ...
                  sx={{ my: 1, color: "white", display: "block", ml: 3 }}
                >
                  {page}
                </Button>
              ))}
        ...
        <Grid container spacing={2} justifyContent={"center"}>
          <Grid item sm={7}>
            ...
            <p className={classes.description}>
              Search 243,000 verses mentioned in 10,000 messages across 100+
              channels
            </p>
          </Grid>
        </Grid>
